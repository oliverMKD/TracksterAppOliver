...
class SelectTruckAdapterDouble (private val activity: Activity) :
    RecyclerView.Adapter<SelectTruckAdapterDouble.LoadsRecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(holder: LoadsRecyclerViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (truck != null) {
                (activity as MainScreenActivity).getSelectedTruck(truck.name)
            }
        }
    }
}