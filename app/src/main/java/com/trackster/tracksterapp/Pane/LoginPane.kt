...
class LoginPane : AppCompatActivity(), OnMapReadyCallback, View.OnClickListener {
    ...
    private fun validatePhone() {
        ...
        val token = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjVjNmM3NmViMTdkNDQyMTc3MGFlMTg4ZCIsImNvbXBhbnlJZCI6IjVjNmMwMWI3ZjRlNWYzMWMzYzkxYzc4MCIsImZpcnN0TmFtZSI6IlByb2JhIiwibGFzdE5hbWUiOiJCcm9rZXIyIiwidXNlclR5cGUiOjMsImlhdCI6MTU1Nzc2MzQzNiwiZXhwIjoxNTU4MzY4MjM2fQ.AAUTU9TBaAaWZK_hgA2p_10NecT245QmG4krAd0UeWY"
